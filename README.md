...
The Video Management Service enabling a shared video platform and use cases like live streaming static (e.g. Youtube, Netflix) or dynamic content (e.g. Twitch, Kick). The platform is exposing HTTP endpoints in which to
