...
impl Mp4Parser {
    ...
    pub fn parse(&self, filename: &str) -> 
    Result<(ContainerMeta, Option<VideoTrack>, Option<AudioTrack>, Option<SubtitleTrack>), Box<dyn std::error::Error>> {
        ...
        info!("Successfull parsed filename {}", filename );
...
mod tests {
    ...
    fn test_mp4_parser() {
        ...
        let (container_meta, video_track, audio_track, subtitle_track) = mp4_parser.parse("assets/nature2.mp4").unwrap();
